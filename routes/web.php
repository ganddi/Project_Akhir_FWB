...
Route::middleware('auth', 'role:admin')->group(function () {
    ...
    Route::get('/lihatRentalItem', [admin::class, 'lihatRentalItem'])->name('lihatRentalItem');
    ...
    Route::get('/lihatNotes', [admin::class, 'lihatNotes'])->name('lihatNotes');
    Route::get('/rental/{id}/tambahNotes', [admin::class, 'tambahNotes'])->name('tambahNotes');
    Route::post('/rental/{id}/tambahNotes', [admin::class, 'simpanNotes'])->name('simpanNotes');
});
